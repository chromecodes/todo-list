    ...
    if(dateInput.value === ''){
        ...
        if(taskInput.value.trim() !== ''){
            ...
            if(a.name === 'projects'){
                ...
                _object__WEBPACK_IMPORTED_MODULE_0__.object.addProjectValue(v, taskInput.value,dateInput.value, priorityInput.value);
                console.log(a);
                    clearContant();
    ...
    checkLbls.forEach(checkLbl => { checkLbl.addEventListener('click', (e)=>{
        ...
        console.log(y);
            if (y === undefined){
                ...
                console.log(_object__WEBPACK_IMPORTED_MODULE_0__.object.objects);
            } else {
...
let newDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date().setHours(0,0,0,0), 7), 'yyyy-MM-dd');
        ...
        {name: "Tasks", 
         ...
         {name: 'projects', 
          obj:[{ title: 'GYM',
                ...
                { title: 'Books to read',
                  value:[
                            {task : "Chosen Ones", date: `${(0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(), 'yyyy-MM-dd')}`, priority: "low",  completed : true},
