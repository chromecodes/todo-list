      ...
      },
      {
        ...
        obj: [
          ...
          },
          {
            ...
            value: [
              {
                task: "Complete Project Todo-List",
                date: `2022-09-03`,
                priority: "mild",
                completed: true,
              },
              ...
              },
              {
                task: "Start React",
                date: `${format(
                  addDays(new Date().setHours(0, 0, 0, 0), 8),
                  "yyyy-MM-dd"
                )}`,
                priority: "mild",
                completed: false,
          ...
          },
          {
            ...
            value: [
              ...
              },
              {
                task: "Atomic Habits",
                date: `${format(
                  addDays(new Date().setHours(0, 0, 0, 0), 9),
                  "yyyy-MM-dd"
                )}`,
                priority: "low",
                completed: false,
